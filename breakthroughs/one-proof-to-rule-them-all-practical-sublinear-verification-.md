...
## Related
- [[threshold-lattice-based-zero-knowledge-proofs|Threshold Lattice-Based Zero-Knowledge Proofs]]
- [[actively-secure-two-party-function-secret-sharing-with-dynam|Actively Secure Two-Party Function Secret Sharing with Dynamic Cross-Phase Verification]]
