...
## Related
- [[el-agente-potente-high-throughput-agentic-atomistic-simulati|El Agente Potente: High-Throughput Agentic Atomistic Simulations]]
- [[frugal-bayesian-optimization-scalable-surrogates-for-data--a|Frugal Bayesian Optimization: Scalable Surrogates for Data- and Resource-Limited Discovery]]
- [[multi-agent-closed-loop-reasoning-for-organic-structure-eluc|Multi-Agent Closed-Loop Reasoning for Organic Structure Elucidation from Multimodal Spectra]]
- [[mdarena-evaluating-coding-agents-on-realistic-molecular-dyna|MDArena: Evaluating Coding Agents on Realistic Molecular Dynamics Workflows]]
