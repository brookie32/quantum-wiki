...
## Related
- [[graph-neural-network-force-fields-gptff-mol-for-organic-mole|Graph Neural Network Force Fields (GPTFF-mol) for Organic Molecules from Optimization Trajectories (OpenGEM26)]]
...
- [[transferable-fb-gnn-mbe-framework-for-potential-energy-surfa|Transferable FB-GNN-MBE Framework for Potential Energy Surfaces: Data-Adaptive Transfer Learning in Deep Learned Many-Body Expansion Theory]]
