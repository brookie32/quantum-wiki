...
## Related
- [[classical-tensor-network-and-quantum-fourier-transform-appro|Classical Tensor Network and Quantum Fourier Transform Approaches for Large-Scale Carr-Madan Option Pricing]]
- [[iterative-tensor-network-transformations-for-element-wise-ev|Iterative tensor network transformations for element-wise evaluation of elementary and filtering functions]]
