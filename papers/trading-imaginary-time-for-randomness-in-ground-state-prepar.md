...
- [[ground-state-energies-of-ising-models-calculated-using-the-s|Ground-state energies of Ising models calculated using the samples from a quantum computer that simulates short-time evolution]]
- [[accurate-ground-state-energy-estimation-with-noise-and-imper|Accurate ground state energy estimation with noise and imperfect state preparation]]
